...
from Population_encoder_decoder import Population
from Individual_encoder_decoder import Individual
from multiprocessing import Pool
from rnn import rnnModel
from utilities.utils import save_model
from utilities.utils import EV_Stats_encoder_decoder as EV_Stats
...
class EV:
	...
	def run(self):
		...
		# save statistics
		f_name = "ende_stat_gen{}_pop{}_in{}_h{}_o{}_reduce{}".format(self.config.generationCount,
		...
		y_hat = ind.generate(len(self.observed_sequence)).reshape(-1)
		self.gen = y_hat
		#plt.hist(y_hat, 100)
		#plt.show()
		music_save("ende_gen{}_pop{}_in{}_h{}_o{}_reduce{}".format(self.config.generationCount,
																			self.config.populationSize,
																			Individual.inputSize,
																			Individual.hiddenSize,
																			Individual.outputSize,
